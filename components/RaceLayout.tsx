...
const LossLandscape = dynamic(() => import('./LossLandscape'), {
  ssr: false,
  loading: () => (
    <div className="w-full h-full flex items-center justify-center bg-tera">
      <div className="text-orange-500 animate-pulse">Loading 3D Scene...</div>
    </div>
  ),
});
...
export default function RaceLayout({ userPickId, onPlayAgain }: RaceLayoutProps) {
  ...
  return (
    <div className="h-screen w-screen flex flex-col bg-tera overflow-hidden">
